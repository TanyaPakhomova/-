...
public class AddressApiTest {
    ...
    void testGetAddressById() throws IOException, InterruptedException, URISyntaxException, SQLException {
        when(addressDAO.getAddressById(8)).thenReturn(new Address(8, "pushkina", "moscow", "msk", "1111", 1));
        ...
        assertTrue(responseBody.contains("pushkina"));
        assertTrue(responseBody.contains("moscow"));
        assertTrue(responseBody.contains("1111"));
